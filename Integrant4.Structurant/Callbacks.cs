...
namespace Integrant4.Structurant
{
    ...
    public partial class Member<TObject, TState, TValue>
    {
        public static class Callbacks
        {
            ...
            public delegate void ValueSetter(MemberInstance<TObject, TState, TValue> inst, TValue? value);

            public delegate Task<IReadOnlyList<IValidation>> ValidationGetter(MemberInstance<TObject, TState, TValue> inst);
        }
    }
}